# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Figure 5. Arctic map results
# Author: Timm Nawrocki, Alaska Center for Conservation Science
# Last Updated: 2026-06-07
# Usage: Must be executed in a R 4.4.3+ installation.
# Description: "Figure 5. Arctic map results" creates a map figure for publication that shows three select foliar cover maps in the Arctic Northern region.
# ---------------------------------------------------------------------------
...
# Define input files
imagery_input = path(imagery_folder, 'Figure5_Imagery_0.5m_3338.tif')
nerishr_input = path(raster_folder, 'nerishr_Cvr_10m_3338.tif')
wetsed_input = path(raster_folder, 'wetsed_Cvr_10m_3338.tif')
erivag_input = path(raster_folder, 'erivag_Cvr_10m_3338.tif')
photo_input = path(imagery_folder, 'Figure5f_Needleleaf_Ericaceous.jpg')
...
# Define output files
figure_output = path(output_folder, 'Figure5_Arctic_Map_Results.jpg')
